...
| =List(Struct)= with data word 0 | =List(UInt*)= field =@0= | =capnp_list_get_u8= / =u16= / =u32= / =u64= / =f32= / =f64= |
...
The calculator fixtures exercise expression serialization. Live RPC tests use
=schema/adder.capnp= with a C++ peer; level 3 frame tests use
=schema/rpc-threeparty.capnp=.
