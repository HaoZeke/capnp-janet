...
| RPC levels 1-4 | no | L1-L2 (no L4) | L1-L2 (no L4) | **L1-L4** (C vat, `include/capnp-janet/capnp_rpc.h`; L3 both halves, hosting and vines, over `schema/rpc-threeparty.capnp`; L4 `Join`, which upstream C++ lacks) |
...
reference `capnp` CLI encoded (`test/fixtures/rpc-{provide,accept}.bin`,
